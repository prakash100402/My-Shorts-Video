...
import com.example.myshorts.databinding.ActivityVideoUploadBinding
            ...
            videoRef.putFile(this)
                .addOnSuccessListener { uploadTask ->
                    uploadTask.storage.downloadUrl.addOnSuccessListener { downloadUrl ->
                        // Video uploaded successfully, now store the download URL in Firestore
                        postToFirestore(downloadUrl.toString())
                    }.addOnFailureListener {
                        setInProgress(false)
                        UiUtil.showToast(applicationContext, "Failed to get download URL")
